...
| --- | --- |
| **New Session** (`+`) | Prompt for a name and open a fresh shell under dtach. When `suggestSessionName` is enabled, the name is pre-filled and fully selected so Enter creates immediately. |
